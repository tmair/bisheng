...
const NotFound = require('{{ themePath | safe }}/template/NotFound');
...
function templateWrapper(template, dataPath = '') {
  const Template = require('{{ themePath | safe }}/template' + template.replace(/^\.\/template/, ''));
...
const theme = require('{{ themePath | safe }}');
